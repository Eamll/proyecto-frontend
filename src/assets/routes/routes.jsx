...
const ContentWithSidebar = () => {
    ...
    return (
        <>
            {(location.pathname === "/catalogos" || location.pathname === "/crear-ingreso" || location.pathname === "/ingreso-compra" || location.pathname === "/crear-salida" || location.pathname === "/crear-traspaso") && (
                <Sidebar
